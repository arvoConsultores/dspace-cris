...
public final class CreateAdministrator
{
     ...
     * arguments, it will negotiate with the user for the administrator details
     * 
     * @param argv
    ...
    protected CreateAdministrator() throws Exception
    {
        ...
        ePersonService = EPersonServiceFactory.getInstance()
                .getEPersonService();
    }
     ...
     * @throws Exception
     */
    protected void negotiateAdministratorDetails() throws Exception
    {
        ...
        createAdministrator(email, firstName, lastName, language,
    ...
    /**
     * Create the administrator with the given details. If the user already
     * exists then they are simply upped to administrator status
     * 
     * @param email
    ...
    protected void createAdministrator(String email, String first, String last,
            String language, String pw) throws Exception
    {
        ...
        if (admins == null)
        {
            throw new IllegalStateException(
                    "Error, no admin group (group 1) found");
        }
