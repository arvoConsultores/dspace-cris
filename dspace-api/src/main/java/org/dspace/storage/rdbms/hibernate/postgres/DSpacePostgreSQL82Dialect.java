...
/**
 * UUID's are not supported by default in hibernate due to differences in the
 * database in order to fix this a custom sql dialect is needed. Source:
...
public class DSpacePostgreSQL82Dialect extends PostgreSQL82Dialect {
	...
	/**
	 * Override is needed to properly support the CLOB on metadatavalue in
	 * postgres & oracle.
	 * 
	 * @param sqlCode
	 * @return
