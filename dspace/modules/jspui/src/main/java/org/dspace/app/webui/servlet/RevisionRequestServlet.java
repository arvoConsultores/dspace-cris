 ...
 * @version $Revision$
 */
public class RevisionRequestServlet extends DSpaceServlet
{
    /** Logger */
    private static Logger log = Logger.getLogger(RevisionRequestServlet.class);
            ...
            SQLException, AuthorizeException
    {
        ...
        log.info(LogManager.getHeader(context, "revision_request", ""));
//        // QUITAR!!!!
//        try {
...
//	}
        ...
        //
        JSPManager.showJSP(request, response, "/openaire/revisionRequest.jsp");
    }
            ...
            SQLException, AuthorizeException
    {
	 ...
	 if(StringUtils.isEmpty(email)){
		...
		log.error("Error enviando mail en RevisorRequestServlet",e);
		e.printStackTrace();
	    }
            ...
            JSPManager.showJSP(request, response,"/openaire/revisionRequest-sent.jsp");
