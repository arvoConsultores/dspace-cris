...
<dspace:layout style="submission" titlekey="jsp.revisionRequest.title" nocache="true">

    <%-- <h1>Edit Your Profile</h1> --%>
	<h1><fmt:message key="jsp.revisionRequest.title"/>
...
%>
	...
	<p class="alert alert-info"><fmt:message key="jsp.revisionRequest.missing.email"/></p>
<%
    }
...
%>
	...
	<p class="alert alert-warning"><fmt:message key="jsp.revisionRequest.error.email"/></p>
<%
    }
...
%>
    <%-- <p><strong>The passwords you enter below must match, and need to be at
    least 6 characters long.</strong></p> --%>
	<p class="alert alert-warning"><fmt:message key="jsp.revisionRequest.forbiden.email"/></p>
<%
    }
%>

	<div class="alert alert-info"><fmt:message key="jsp.revisionRequest.info3"/></div>
    
    <form class="form-horizontal" action="<%= request.getContextPath() %>/revisionRequest" method="post">
		...
		<p class="alert"><fmt:message key="jsp.revisionRequest.info5"/></p>
			...
			<label class="col-md-offset-3 col-md-2 control-label" for="email"><fmt:message
					key="jsp.revisionRequest.email.field" /></label>
			<div class="col-md-3">
